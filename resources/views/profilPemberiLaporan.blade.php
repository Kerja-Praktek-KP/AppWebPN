...
<body class="bg-[#F2F3F9] overflow-hidden" x-data="{ sidebarOpen: true, isEditing: false, user: { nama: 'Arie', nip: '2104111010066', email: 'Arie@gmail.com', password: '******' }, editUser: {} }">
    ...
    <div class="flex h-screen">
        ...
        <aside :class="{'w-60': sidebarOpen, 'w-16': !sidebarOpen, 'sidebar-visible': sidebarOpen, 'sidebar-hidden': !sidebarOpen}" class="bg-white text-black flex flex-col transition-all duration-300 sidebar">
            <nav class="flex-1">
                <ul>
                    ...
                    <li class="flex justify-center p-2 mx-6">
                        <a href="profilPemberiLaporan" class="flex items-center px-5 py-3 bg-[#22805E]" x-show="!sidebarOpen" title="Profile">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 16.1716C18.0783 15.4214 17.0609 15 16 15H8C6.93913 15 5.92172 15.4214 5.17157 16.1716C4.42143 16.9217 4 17.9391 4 19V21" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 11C14.2091 11 16 9.20914 16 7C16 4.79086 14.2091 3 12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
        ...
        <div :class="sidebarOpen ? 'w-11/12' : 'w-full'" class="flex-1 p-12 ml-0 md:ml-28 lg:ml-16 xl:ml-60 items-center justify-center transition-all duration-300 sidebar main-content">
            <div class="flex flex-col lg:flex-row items-center justify-center bg-white h-fit w-80 md:w-80 lg:w-fit mr-44 md:mr-0 rounded-[5-x] ">
                ...
                <div class="items-center w-1/2 mt-6 mr-0 md:mr-20">
                    ...
                    <div class="flex items-center mb-2">
                        <span class="w-3/4 font-semibold text-[14px] md:text-[12px] lg:text-base text-black">Jabatan :</span>
                        <template x-if="!isEditing">
                            <span x-text="user.nama" class="w-3/4 text-[14px] md:text-[12px] lg:text-base font-semibold text-black p-1"></span>
                        </template>
                        <template x-if="isEditing">
                            <select class="w-3/4 text-[14px] md:text-[12px] lg:text-base font-semibold text-black p-1">
                    ...
                    <div class="flex flex-row item-center justify-start mt-4 mb-8">
                        <template x-if="!isEditing">
                            <button @click="isEditing = true; editUser = { ...user }" class="flex bg-[#006634] text-white text-[14px] md:text-[12px] font-semibold px-4 py-1 rounded-[5px] shadow-md hover:bg-green-800">
                        ...
                        <template x-if="isEditing">
                            <div>
                                <button @click="isEditing = false; user = { ...editUser }" class="bg-[#006634] text-white font-semibold px-8 py-1.5 shadow-md rounded-[5px] mr-4 mb-2">Simpan</button>
                                <button @click="isEditing = false; editUser = { ...user }" class="border border-[#006634] text-[#006634] font-semibold px-8 py-1.5 shadow-md rounded-[5px]">Batal</button>
                            </div>
                        </template>
                    </div>
                </div>
