...
<body class="bg-[#F2F3F9] overflow-hidden" x-data="{ sidebarOpen: true }">
    ...
    <div class="flex h-screen">
        ...
        <main :class="sidebarOpen ? 'w-11/12' : 'w-full'" class="flex-1 flex-col overflow-y-auto mb-20 mt-12">
            <!-- Tabel TLHP Bulanan -->
            <div id="tlhp-bulanan" class="tlhp bg-white p-1 md:p-4 w-10/12 md:w-11/12 rounded-[5px] mx-auto">
        ...
        <script>
            ...
            let tlhpBulanan = {!! json_encode($tlhpBulanan->map(function($laporan) {
                return [
                    'id' => $laporan->id,
            ...
            function renderTable() {
                ...
                tlhpBulanan.forEach((report, index) => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[8px] md:text-[12px] capitalize">
                            <a href="/downloadstatusTLHPBulananPL/${report.id}" class="text-green-700 flex justify-center" download>
