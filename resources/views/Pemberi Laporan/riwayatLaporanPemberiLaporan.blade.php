...
<body class="bg-[#F2F3F9] overflow-hidden" x-data="{ sidebarOpen: true }">
    ...
    <div class="flex h-screen">
        ...
        <script>
            //script pemanggilan laporan dari database
            let reports = {
                mingguan: {!! json_encode($laporanMingguan->map(function($laporan) {
                    return [
                        'id' => $laporan->id,
                ...
                bulanan: {!! json_encode($laporanBulanan->map(function($laporan) {
                    return [
                        'id' => $laporan->id,
                        'judul' => $laporan->nama_laporan_with_format,
                        'jenis' => $laporan->bulan,
