                  ...
                  <div class="flex items-center justify-center">
                    ...
                    <div class="flex flex-col justify-center mr-2 max-w-full">
                      <h2 class="text-sm sm:text-lg font-semibold w-auto overflow-hidden text-ellipsis whitespace-nowrap  truncate max-w-[35ch] sm:max-w-[45ch] md:max-w-[40ch] lg:max-w-[40ch] xl:max-w-[70ch]">
                        Temuan adalah sesbiasdnalaflaakjflafdsjlkafjlkasdjkfljlkasldjflajkadsklfjasdklfjajlskfjklsajflkasjkln
                      </h2>
                      <h2 class="text-[10px] md:text-base text-[#696767] font-normal w-auto overflow-hidden text-ellipsis whitespace-nowrap truncate max-w-[35ch] sm:max-w-[45ch] md:max-w-[40ch] lg:max-w-[40ch] xl:max-w-[70ch]">
                        Judul Temuan
                      </h2>
                    </div>
                  </div>
                  <button class="flex items-center justify-center bg-[#22805E] text-white font-semibold px-2 sm:px-4 py-1 rounded-[5px] shadow-md hover:bg-green-800">
