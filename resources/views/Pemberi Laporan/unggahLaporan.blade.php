...
<body class="bg-[#F2F3F9] overflow-hidden" x-data="{ sidebarOpen: true, jenisLaporan: 'Laporan Mingguan' }" >
    ...
    <div class="flex h-screen ">
            ...
            <nav class="flex-1 ">
                <ul>
                    ...
                    <li class="flex justify-center p-2 mx-6">
                        <a href="unggahLaporan" class="flex items-center px-5 py-3 bg-[#22805E]" x-show="!sidebarOpen" title="Unggah Laporan">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M14 2V8H20" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 18V12" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div class="flex-col bg-white p-2 sm:p-6 lg:p-7 rounded-[5px] ps-2shadow-2xl my-auto mx-auto w-full sm:w-10/12 md:w-8/12 lg:w-7/12 h-fit md:h-auto sm:h-3/4 mt-2 md:mt-5 lg:mt-10 ml-5 md:ml-auto mr-5 md:mr-auto overflow-y-auto">
            ...
            <form action="{{ route('unggahLaporanPL') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group"  x-show="jenisLaporan === 'Laporan Mingguan' || jenisLaporan === 'TLHP Mingguan'">
