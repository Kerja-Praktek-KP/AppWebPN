            ...
            <nav class="flex-1">
                <ul>
                    ...
                    <li class="flex justify-center p-2 mx-">
                        <a href="pemberitahuan" class="hover:bg-gray-200 px-5 py-3" class="hover:bg-gray-200 px-5 py-3" x-show="!sidebarOpen" title="Pemberitahuan">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#22805E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 8V12" stroke="#22805E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 16H12.01" stroke="#22805E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <li class="flex justify-center p-2 mx-6">
                        <a href="riwayatTLHPPemberiLaporan" class="flex items-center px-5 py-3 bg-[#22805E]" x-show="!sidebarOpen" title="Riwayat TLHP">
                            <svg width="22" height="24" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.5 19.5L19 21M12 17C12 17.7956 12.3161 18.5587 12.8787 19.1213C13.4413 19.6839 14.2044 20 15 20C15.7956 20 16.5587 19.6839 17.1213 19.1213C17.6839 18.5587 18 17.7956 18 17C18 16.2044 17.6839 15.4413 17.1213 14.8787C16.5587 14.3161 15.7956 14 15 14C14.2044 14 13.4413 14.3161 12.8787 14.8787C12.3161 15.4413 12 16.2044 12 17Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M17 11V4.749C17.0001 4.67006 16.9845 4.59189 16.9543 4.51896C16.9241 4.44603 16.8798 4.37978 16.824 4.324L13.676 1.176C13.5636 1.06345 13.4111 1.00014 13.252 1H1.6C1.44087 1 1.28826 1.06321 1.17574 1.17574C1.06321 1.28826 1 1.44087 1 1.6V20.4C1 20.5591 1.06321 20.7117 1.17574 20.8243C1.28826 20.9368 1.44087 21 1.6 21H8" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M13 1V4.4C13 4.55913 13.0632 4.71174 13.1757 4.82426C13.2883 4.93679 13.4409 5 13.6 5H17" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </a>
                    </li>
                    <li class="flex justify-center p-2 mx-6">
        ...
        <main :class="sidebarOpen ? 'w-11/12' : 'w-full'" class="flex-1 flex-col transition-all duration-300 overflow-y-auto mb-20">
            ...
            <div class="flex p-8 mx-1">
                <ul class="flex border bg-[#C5D9CF] rounded-md">
                    <li class="">
                        <a id="mingguan-tab" class="inline-block py-1 md:py-2 px-2 md:px-4 w-24 md:w-36 border text-center bg-[#22805E] rounded-[5px] text-[14px] md:text-base text-white font-semibold cursor-pointer" onclick="showTab('mingguan')">Mingguan</a>
                    </li>
                    <li class="">
                        <a id="bulanan-tab" class="inline-block py-1 md:py-2 px-2 md:px-4 w-24 md:w-36 text-center text-[#22805E] rounded-[5px] text-[14px] md:text-base font-semibold cursor-pointer" onclick="showTab('bulanan')">Bulanan</a>
                    </li>
                </ul>
            </div>
        
            <div id="tlhp-mingguan" class="category laporan bg-white p-1 md:p-4 w-10/12 md:w-11/12 rounded-[5px] mx-auto">
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            ...
                            <th class="px-2 md:px-5 py-3 text-center text-[10px] md:text-xs font-bold text-black uppercase tracking-normal">Jenis Laporan</th>
                    ...
                    <tbody id="mingguanTableBody">
                        <!-- Baris data laporan mingguan akan ditambahkan di sini menggunakan JavaScript -->
                    </tbody>
                </table>
            </div>
        
            <div id="tlhp-bulanan" class="category laporan hidden bg-white p-1 md:p-4 w-10/12 md:w-11/12 rounded-[5px] mx-auto">
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            <th class="px-2 md:px-5 py-3 text-center text-[10px] md:text-xs font-bold text-black uppercase tracking-normal">No.</th>
                    ...
                    <tbody id="bulananTableBody">
                        <!-- Baris data laporan bulanan akan ditambahkan di sini menggunakan JavaScript -->
                    </tbody>
                </table>
            </div>
            ...
            <div class="flex justify-end items-center mt-8 mr-16">
                <button id="prevPage" class="p-0.5 bg-white rounded-l-[5px] hover:bg-gray-300" onclick="changePage('prev')">
                ...
                <button id="nextPage" class="p-0.5 bg-white rounded-r-[5px] hover:bg-gray-300" onclick="changePage('next')">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 md:h-6 w-4 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <script>
            let reports = {
                mingguan: [
                    ...
                    { id: 1, judul: 'TLHP Mingguan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                    { id: 1, judul: 'TLHP Mingguan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                    { id: 1, judul: 'TLHP Mingguan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                    { id: 1, judul: 'TLHP Mingguan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                    { id: 1, judul: 'TLHP Mingguan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                ...
                bulanan: [
                    ...
                    { id: 1, judul: 'TLHP Bulanan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                    { id: 1, judul: 'TLHP Bulanan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                    { id: 1, judul: 'TLHP Bulanan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
                    { id: 1, judul: 'TLHP Bulanan', jenis: 'Jenis Laporan', tanggal: '12 September 2024' },
            ...
            function renderTable(tabName) {
                ...
                currentItems.forEach((report, index) => {
                    ...
                    row.innerHTML =`
                        <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] capitalize">${startIndex + index + 1}</td>
                        <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] capitalize">${report.judul}</td>
                        <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] capitalize">${report.jenis}</td>
                        <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] capitalize">${report.tanggal}</td>
                        <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] capitalize">
                            <a href="#" class="text-green-700 flex justify-center">
            ...
            function showTab(tabName) {
                ...
                document.getElementById(`tlhp-${tabName}`).classList.remove('hidden');
