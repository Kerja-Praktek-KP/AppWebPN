...
<body class="bg-[#F2F3F9] overflow-hidden" x-data="{ sidebarOpen: true }">
    ...
    <div class="flex h-screen">
            ...
            <nav class="flex-1">
                <ul>
                    ...
                    <li class="p-3 pl-8 bg-[#22805E] mx-full my-4" x-show="sidebarOpen">
                        <a href="riwayatLaporanPemberiLaporan" class="flex items-center text-white font-medium">
                            <svg class="mr-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="flex justify-center p-2 mx-6">
                        <a href="riwayatLaporanPemberiLaporan" class="flex items-center px-5 py-3 bg-[#22805E]" x-show="!sidebarOpen" title="Riwayat Laporan">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 6V12L16 14" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
        ...
        <!-- Main Content -->
        <main :class="sidebarOpen ? 'w-11/12' : 'w-full'" class="flex-1 flex-col overflow-y-auto mb-20">
            <!-- Tabs -->
            ...
            <div id="laporan-bulanan" class="category laporan hidden bg-white p-1 md:p-4 w-10/12 md:w-11/12 rounded-[5px] mx-auto">
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            <th class="px-2 md:px-5 py-3 text-center text-[10px] md:text-xs font-bold text-black uppercase tracking-normal">No.</th>
            ...
            function renderTable(tabName) {
                ...
                currentItems.forEach((report, index) => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] md:text-xs capitalize">${report.jenis}</td>
