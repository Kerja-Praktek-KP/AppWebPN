...
<body class="bg-[#F2F3F9] overflow-hidden" x-data="{ sidebarOpen: true, isEditing: false, user: { nama: 'Arie', nip: '2104111010066', email: 'Arie@gmail.com', password: '******', jabatan: 'Pemberi Laporan', bidang: 'Sub Bag. Perencanaan, Ti dan Pelapran' }, editUser: {nama: '', nip: '', email: '', password: ''} }">
