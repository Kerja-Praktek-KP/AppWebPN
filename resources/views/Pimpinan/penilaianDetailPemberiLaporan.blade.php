            ...
            <nav class="flex-1">
                <ul>
                    <li class="p-3 pl-8 bg-[#22805E] mx-full my-4" x-show="sidebarOpen">
                        <a href="berandaPimpinan" alt="Beranda" class="flex items-center text-white font-medium">
                    ...
                    <li class="flex justify-center p-2 mx-6 mt-2">
                        <a href="berandaPimpinan" class="bg-[#22805E] px-5 py-3" x-show="!sidebarOpen" title="Beranda">
        ...
        <main :class="sidebarOpen ? 'w-11/12' : 'w-full'" class="flex-1 flex-col transition-all p-4 duration-300 overflow-y-auto pb-24">
            ...
            <div class="flex justify-between items-center mb-4">
                <ul class="flex border bg-[#C5D9CF] rounded-[5px]">
                    <li class="">
                        <a id="laporan-tab" class="inline-block md:py-1 lg:py-2 px-4 md:w-28 lg:w-36 border text-center bg-[#22805E] rounded-[5px] text-white font-semibold px]cursor-pointer" onclick="showTab('laporan')">Laporan</a>
                    </li>
                    <li class="">
            ...
            <!-- Table -->
            <!-- Tabel untuk Laporan -->
            <div id="laporan" class="category laporan hidden bg-white p-2 w-full rounded-[5px] mx-auto">
        ...
        function renderTable(tabName) {
            ...
            currentItems.forEach((report, index) => {
                ...
                <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] md:text-[12px] capitalize">${startIndex + index + 1}</td>
                    ...
                    <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] md:text-[12px] capitalize">${report.jenis}</td>
                    <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] md:text-[12px] capitalize">
                        <a href="/downloadLaporanPLuntukPimpinan/${report.id}" class="text-green-700 flex justify-center" download>
                            <button>
