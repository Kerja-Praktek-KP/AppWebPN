...
<body class="bg-[#F1F5FE] overflow-hidden" x-data="{ sidebarOpen: true, showPopup: false }">
    ...
    <div class="flex h-screen">
        ...
        <main :class="sidebarOpen ? 'w-11/12 ' : 'w-full'" class="flex-1 pt-14 mx-52 transition-all duration-300"> 
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <h2 class="text-xl font-bold mb-4">Masukkan Data Pengguna Baru</h2>
                <form @submit.prevent="showPopup = true">
                    <div class="mb-4 flex items-center">
                        <label class="block text-sm font-medium text-gray-700 w-1/4">Nama</label>
                        <input type="text" placeholder="Masukkan Nama" class="w-3/4 border-gray-300 rounded-md shadow-sm">
                    </div>
                    <div class="mb-4 flex items-center">
                        <label class="block text-sm font-medium text-gray-700 w-1/4">NIP</label>
                        <input type="text" placeholder="Masukkan NIP" class="w-3/4 border-gray-300 rounded-md shadow-sm">
                    </div>
                    <div class="mb-4 flex items-center">
                        <label class="block text-sm font-medium text-gray-700 w-1/4">Email</label>
                        <input type="email" placeholder="Masukkan Email" class="w-3/4 border-gray-300 rounded-md shadow-sm">
                    </div>
                    <div class="mb-4 flex items-center">
                        <label class="block text-sm font-medium text-gray-700 w-1/4">Password</label>
                        <input type="password" placeholder="Masukkan Password" class="w-3/4 border-gray-300 rounded-md shadow-sm">
                    </div>
                    <div class="mb-4 flex items-center">
                        <label class="block text-sm font-medium text-gray-700 w-1/4">Divisi</label>
                        <select class="w-3/4 border-gray-300 rounded-md shadow-sm">
                            <option>Pilih Divisi</option>
                        </select>
                    </div>
                    <div class="mb-4 flex items-center">
                        <label class="block text-sm font-medium text-gray-700 w-1/4">Jabatan</label>
                        <select class="w-3/4 border-gray-300 rounded-md shadow-sm">
                            <option>Pilih Jabatan</option>
                        </select>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700">Tambah Pengguna</button>
                    </div>
                </form>
            </div>
        </main>
        ...
        <div x-show="showPopup" x-transition class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                ...
                <button @click="showPopup = false" class="bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700">OK</button>
            </div>
        </div>
    </div>
</body>
