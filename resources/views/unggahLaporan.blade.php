...
<body class="bg-[#F2F3F9] overflow-hidden" x-data="{ sidebarOpen: true }">
    ...
    <div class="flex h-screen ">
        ...
        <!-- Main Content -->
        <main class=" p-2 sm:p-6 lg:p-7 rounded-[5px] ps-2shadow-2xl my-auto mx-auto w-full h-full">
            <div class="flex-col bg-white p-2 sm:p-6 lg:p-4 rounded-[5px] my-auto mx-auto w-full sm:w-10/12 md:w-8/12 lg:w-7/12 h-fit md:h-auto sm:h-3/4 mt-4 md:mt-5 lg:mt-10 ml-2 md:ml-auto mr-5 md:mr-auto">
                <div class="flex flex-col">
                    <div class="flex items-center justify-between">
                        <div class="flex">
                            <img src="{{ asset('images/google_docs.png') }}" alt="" class="w-12 h-12">
                            <div class="flex flex-col mx-4">
                                <h2 class="text-base md:text-xl lg:text-1xl font-bold">Format Laporan Lama</h2>
                                <p class="text-sm text-gray-600 italic">Format Laporan Harus .docx</p>
                            </div>
                        </div>
                        <button class="bg-[#22805E] text-white text-base md:text-lg font-semibold mt-4 sm:mt-0 mr-0 sm:mr-2 px-10 py-1 rounded-[12px] hover:bg-[#1A5D45] flex flex-row">
                            <span> Unduh</span>                       
                        </button>
                    </div>
                </div>                
            ...
            <div class="flex-col bg-white p-2 sm:p-6 lg:p-7 rounded-[5px] ps-2shadow-2xl my-auto mx-auto w-full sm:w-10/12 md:w-8/12 lg:w-7/12 h-fit md:h-auto sm:h-3/4 mt-4 md:mt-5 lg:mt-10 ml-5 md:ml-auto mr-5 md:mr-auto">
                <div class="flex flex-row justify-between items-center mb-6 border-b-2 pb-4">
                    <h2 class="text-base md:text-xl lg:text-1xl font-bold">Masukkan Format Laporan</h2>
                </div>
                    ...
                    <div class="flex justify-center pb-4">
                        <button type="submit" class="mt-1 lg:mt-6 bg-[#22805E] text-white text-[13px] md:text-lg font-semibold px-10 py-1 rounded-[12px] hover:bg-[#1A5D45]">
                            Unggah
                        </button>
                    </div>
                </form>
