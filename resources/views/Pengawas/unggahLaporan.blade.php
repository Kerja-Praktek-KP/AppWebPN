    ...
    <div class="flex h-screen ">
        ...
        <aside :class="{'w-60': sidebarOpen, 'w-16': !sidebarOpen, 'sidebar-visible': sidebarOpen, 'sidebar-hidden': !sidebarOpen}" class="bg-white text-black flex flex-col transition-all duration-300 sidebar">
            <nav class="flex-1">
                <ul>
                    ...
                    <li class="p-3 pl-8 hover:bg-gray-200 mx-full my-4" x-show="sidebarOpen">
                        <a href="penilaianDetailPemberiLaporanPengawas" class="flex items-center font-medium">
                            <svg class="mr-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex-col bg-white p-2 sm:p-6 lg:p-7 rounded-[5px] ps-2shadow-2xl my-auto mx-auto w-full sm:w-10/12 md:w-8/12 lg:w-7/12 h-fit md:h-auto sm:h-3/4 mt-2 md:mt-5 lg:mt-10 ml-5 md:ml-auto mr-5 md:mr-auto overflow-y-auto">
            <div class="flex flex-row justify-between items-center mb-2 md:mb-6 border-b-2 pb-4">
                ...
                <a href="{{ route('formatLaporan.download') }}" class="bg-[#22805E] text-white text-base md:text-lg font-semibold mt-4 sm:mt-0 mr-0 sm:mr-2 px-3 py-1 rounded-[5px] hover:bg-[#1A5D45] flex flex-row">
                    <span class="button-text" style="justify-between">Template Laporan</span>
            ...
            <form action="{{ route('unggahLaporanPW') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group" x-model="jenisLaporan">
                    ...
                    <select id="jenis-laporan" name="jenis" class="text-[13px] md:text-md custom-caret pl-3 mt-o md:mt-1 block w-full border-gray-300 rounded-md shadow-md h-10">
                        <option value="Laporan Mingguan">Laporan Mingguan</option>
                        <option value="Laporan Bulanan">Laporan Bulanan</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="bulan" class="block text-[13px] md:text-lg font-medium text-gray-700">Bulan</label>
                    <select id="bulan" name="bulan" class="text-[13px] md:text-md custom-caret pl-3 mt-o md:mt-1 block w-full border-gray-300 rounded-md shadow-md h-10">
                ...
                <div class="file-upload-container">
                    ...
                    <div class="mt-o md:mt-6 flex justify-center w-full md:w-8/12 pt-1 md:pt-5 pb-1 md-pb-6 border-2 bg-[#E1ECE7] border-[#006634] border-dashed rounded-md" id="file-dropzone">
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex flex-col px-7 items-center text-[13px] md:text-base text-gray-600">
                                ...
                                <span class="mr-2 md:mr-0 mt-2 md:mt-0 relative cursor-pointer bg-[#E1ECE7] rounded-md font-medium text-green-600 hover:text-green-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-green-500 flex-shrink-0">Pilih Berkas</span>
