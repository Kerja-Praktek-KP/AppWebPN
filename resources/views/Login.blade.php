...
<body class="flex items-center justify-center min-h-screen bg-[#22805E]">
    <div class="bg-white p-4 md:p-8 rounded-[5px] shadow-lg w-10/12 sm:w-4/5 md:w-3/5 lg:w-2/5 xl:w-1/3 2xl:w-1/4">
        ...
        @if ($errors->any())
            <div class="bg-red-300 border border-red-600 text-white p-3 rounded mb-4 ">
                <ul>
        ...
        <form method="POST" action="/login" class="space-y-4">
            ...
            <div class="relative mb-4">
                <input type="password" id="password" name="password" placeholder="Kata Sandi" required class="w-full p-3 border border-gray-300 rounded-[5px] focus:outline-none focus:ring-2 focus:ring-green-700">
