        ...
        <main :class="sidebarOpen ? 'w-11/12' : 'w-full'" class="flex-1 flex-col transition-all p-4 duration-300 overflow-y-auto pb-24">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="ml-auto flex items-center justify-center">
                    <a href="anggotaKoordinatorPengawas" class="flex w-fit items-center justify-center px-6 py-2 text-[11px] md:text-[12px] lg:text-[12px] bg-white rounded-[5px]">
            ...
            currentItems.forEach((report, index) => {
                ...
                <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] md:text-[12px] capitalize">${startIndex + index + 1}</td>
                    ...
                    <td class="px-2 md:px-4 py-4 text-center font-medium bg-white text-[10px] md:text-[12px] capitalize">
                        <a href="/downloadLaporanPLuntukKoordinatorPengawas/${report.id}" class="text-green-700 flex justify-center" download>
                            <button>
