    ...
    <div class="flex h-screen ">
        ...
        <div class="flex-col bg-white p-2 sm:p-6 lg:p-7 rounded-[5px] ps-2shadow-2xl my-auto mx-auto w-full sm:w-10/12 md:w-8/12 lg:w-7/12 h-fit md:h-auto sm:h-3/4 mt-4 md:mt-5 lg:mt-10 ml-5 md:ml-auto mr-5 md:mr-auto">
            ...
            <form>
                ...
                <div class="form-group">
                    <label for="bulan" class="block text-[13px] md:text-lg font-medium text-black">Bulan</label>
                    <select id="bulan" name="bulan" class="text-[10px] md:text-[14px] custom-caret pl-3 mt-o md:mt-1 block w-full border-gray-300 rounded-md shadow-md h-10 focus:outline-[#D3E6DF]">
