...
<body class="bg-[#F1F5FE] overflow-hidden" x-data="{ sidebarOpen: true }">
    ...
    <div class="flex h-screen">
            ...
            <nav class="flex-1">
                <ul>
                    <li class="p-3 pl-8 hover:bg-gray-200 mx-full my-4" x-show="sidebarOpen">
                        <a href="berandaKoordinatorPengawas" alt="Beranda" class="flex items-center text-black font-medium">
                    ...
                    <li class="p-3 pl-8 bg-[#22805E] mx-full my-4" x-show="sidebarOpen">
                        <a href="riwayatLaporanKoordinatorPengawas" class="flex items-center text-white font-medium">
                            <svg class="mr-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="flex justify-center p-2 mx-6">
                        <a href="unggahLaporanKoordinatorPengawas" class="hover:bg-gray-200 px-5 py-3" x-show="!sidebarOpen" title="Unggah Laporan">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M14 2V8H20" stroke="#22805E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 18V12" stroke="#22805E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M9 15H15" stroke=" " stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </a>
                    </li>
                    <li class="flex justify-center p-2 mx-6">
                        <a href="riwayatLaporanKoordinatorPengawas" class="bg-[#22805E] px-5 py-3" x-show="!sidebarOpen" title="Riwayat Laporan">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 6V12L16 14" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
        ...
        <!-- Main Content -->
        <main :class="sidebarOpen ? 'w-11/12' : 'w-full'" class="p-8 flex-1 flex-col overflow-y-auto mb-20">
            <!-- Table -->
            <div id="riwayat-laporan" class="category laporan bg-white p-1 md:p-4 w-10/12 md:w-11/12 rounded-[5px] mx-auto">
                <table class="min-w-full leading-normal">
                    ...
                    <tbody id="riwayat-laporanTableBody">
                    </tbody>
                </table>
            </div>
        ...
        <script>
            let reports = {
                riwayatLaporan: [
                    { id: 1, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 2, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 3, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 4, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 5, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 6, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 7, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 8, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 9, judul: 'Laporan',  tanggal: '12 September 2024' },
                    { id: 10, judul: 'Laporan',  tanggal: '12 September 2024' },
                ],
            };
            ...
            function renderTable() {
                const tableBody = document.getElementById('riwayat-laporanTableBody');
                tableBody.innerHTML = '';
            ...
            function updatePagination() {
                const pageCount = Math.ceil(reports.riwayatLaporan.length / itemsPerPage);
