    ...
    <header class="w-full flex justify-between bg-white items-center p-2 drop-shadow-md relative z-50">
        ...
        <div class="flex items-center">
            <div class="mx-2 sm:mx-4 flex items-center">
                <img src="{{ asset('images/profile.png') }}" alt="" class="h-10 w-10 rounded-full">
    ...
    <div class="flex h-screen">
        ...
        <main :class="sidebarOpen ? 'w-11/12 ' : 'w-full'" class="flex-1 p-8 overflow-y-auto pb-20 transition-all duration-300"> 
            ...
            <div class="grid-cols-2 grid gap-6 ">                
                <a href="anggotaKoordinatorPengawas" class="bg-white p-2 rounded-[5px] hover:shadow-lg  w-full transition ease-in-out delay-150 hover:-translate-y-0 hover:scale-105 hover:bg-white duration-300 flex flex-col justify-start items-center">
